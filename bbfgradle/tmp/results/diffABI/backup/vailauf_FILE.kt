...
public fun remove(o: ArrayList<Pair<Map<ArrayList<ArrayList<List<String>>>,Float>,Pair<ArrayList<HashSet<Set<String>>>,Map<Set<Boolean>,List<List<HashSet<Long>>>>>>>): Boolean = false
...
protected fun remove(o: T): Set<T> = TODO()
