...
val tests = arrayOf<TestFnBase>(TestFn0, TestFn1, TestFn2, TestFn3, TestFn4, TestFn5, TestFn6, TestFn7, TestFn8, TestFn9,
                                TestFn10, TestFn11, TestFn12, TestFn13, TestFn14, TestFn15, TestFn16, TestFn17, TestFn18, TestFn19,
                                TestFn20, TestFn21, TestFn22)
val prop0 = FloatArray(5)
    val prop1 = prop0.iterator()
    var prop2 = 0
    while ((0 .. 22).none()) {
println("""WHILE (${(0 .. 22).none()})""");
(tests).size
}
    return "dluvn"
}
...
val tests = arrayOf<TestFnBase>(TestFn0, TestFn1, TestFn2, TestFn3, TestFn4, TestFn5, TestFn6, TestFn7, TestFn8, TestFn9,
                                TestFn10, TestFn11, TestFn12, TestFn13, TestFn14, TestFn15, TestFn16, TestFn17, TestFn18, TestFn19,
                                TestFn20, TestFn21, TestFn22)
val prop3 = ArrayList<Pair<String,String>>()
    (TestFn21).toString().toBoolean()
    arrayListOf<Pair<String, String>>().add((prop0).toString().partition({a: Char -> true}))

    val prop4 = prop3.map { it.first }.toTypedArray<String>()

    val prop5 = (::fn21).equals("cnloo").toString()
    if (prop5 != (prop0).equals("dsygv").toString()) {
println("""THEN""");
return "cvjaf"
}

    return (TestFn14).toString()
}
