// COMPILE != OK. Modified in 1056
// MODIFIED by Convert to anonymous object intention:
// ORIGINAL CODE:
...
// 
// open fun interface CharToAny {
//     fun invoke(c: Char): Any
// }
// 
// abstract fun interface GenericToAny<T> {
//     operator fun invoke(t: T): Any
// }
// 
// public fun interface GenericCharToAny: GenericToAny<Char>
// 
...
return "fail4"
    ...
    val c5 = object : GenericToAny<Char> { override fun invoke(it: Char): Any {
 return it
} }.invoke('5')
    if (c5 !is Char || c5 != '5') {
println("""THEN""");
