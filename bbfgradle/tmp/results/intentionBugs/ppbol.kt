...
// 
// sealed interface MyCustomMembers {
//     fun equals(): Boolean
...
tailrec fun KClass<*>.functions()  {
    val name = it.javaMethod!!.name
 return memberFunctions.map { name }.sorted()
}
