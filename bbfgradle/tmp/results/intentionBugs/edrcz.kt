...
//     override operator fun hasNext(): Boolean = unsupported()
...
fun box(): String {
    ...
    asFailsWithCCE("w as MutableIterator<*>") { w as MutableIterator<*> }
    asSucceeds("w as MutableIterable<*>") { w as MutableIterable<*> }
    asSucceeds("w as MutableMap.MutableEntry<*, *>",fun(): MutableMap.MutableEntry<*, *> {
    return w as MutableMap.MutableEntry<*, *>
})
