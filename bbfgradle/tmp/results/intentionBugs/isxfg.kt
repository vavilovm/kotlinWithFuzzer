// EXECUTION FAILED AFTER INTENTION pos 175
...
//     public override val size: Int get() = null!!
//     override fun isEmpty(): Boolean = null!!
//     override infix fun contains(o: String): Boolean = null!!
//     override tailrec operator fun iterator(): Iterator<String> = null!!
//     override tailrec fun containsAll(c: Collection<String>): Boolean = null!!
//     override tailrec operator fun get(index: Int): String = null!!
//     override tailrec fun indexOf(o: String): Int = null!!
...
public class C : Addable, List<String> {
    public override val size: Int=null!!
    override fun isEmpty(): Boolean = null!!
    override infix fun contains(o: String): Boolean = null!!
    override tailrec operator fun iterator(): Iterator<String> = null!!
    override tailrec fun containsAll(c: Collection<String>): Boolean = null!!
