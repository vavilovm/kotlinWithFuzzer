...
//     }
// 
//     tailrec operator fun setValue(instance: Any?, kProperty: KProperty<*>, value: List<String?>) {
...
println("""THEN""");
        ...
        val toString = it.type.toString()
 assertEquals(listOf("kotlin.collections.List<kotlin.String?>"), p.setter.parameters.map { toString })
        assertEquals("kotlin.Unit", p.setter.returnType.toString())
