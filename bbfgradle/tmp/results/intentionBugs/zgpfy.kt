...
const fun getMAX_BYTE(): UByte = 0xFFu
const val HUNDRED: UByte = 100u

const val MAX_LONG: ULong = ULong.MAX_VALUE

const val MAX_BYTE_STRING = "${getMAX_BYTE()}"

const val MAX_LONG_STRING = "$MAX_LONG"

fun box(): String {
    val maxByteStringSingle = "${getMAX_BYTE()}"
    if (maxByteStringSingle != getMAX_BYTE().toString() || maxByteStringSingle != "255") {
println("""THEN""");
return "Fail 1: $maxByteStringSingle"
}
...
return "Fail 2: $twoHundredUByte"
    ...
    val complexOnlyConstants = "Max: ${getMAX_BYTE()}, two hundred: $twoHundredUByte"
    if (complexOnlyConstants != "Max: 255, two hundred: 200") {
println("""THEN""");
return "Fail 3: $complexOnlyConstants"
}
    ...
    val nonConst = UByte.MAX_VALUE + 1u
    val complex = "Max UByte: ${getMAX_BYTE()}, next: $nonConst"
    if (complex != "Max UByte: 255, next: 256") {
println("""THEN""");
return "Fail 4: $complex"
}
