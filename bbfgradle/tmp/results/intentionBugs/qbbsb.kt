...
//     protected var delegatedVarByProvider by Provider(2)
// override fun toString(): String{
// var res = ""
// return res
// }}
...
class Mut<T>( _value: T) {

    var _value = _valuetailrec inline operator fun getValue(thisRef: Any?, kProperty: Any) = _value
