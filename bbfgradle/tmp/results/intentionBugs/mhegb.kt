...
//         tailrec fun concat() = java.lang.String.valueOf(chars)
...
internal open class Outer(vararg val chars: Char) {
    inner class Inner( s: String): Outer(s[0], s[1]) {
        val s = stailrec fun concat() = java.lang.String.valueOf(chars)
    override fun toString(): String{
var res = ""
return res
}}
