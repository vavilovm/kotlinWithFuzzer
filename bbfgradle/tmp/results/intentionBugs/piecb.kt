// EXECUTION FAILED AFTER INTENTION pos 160
...
//     override infix fun indexOf(o: String): Int = null!!
//     override infix fun lastIndexOf(o: String): Int = null!!
//     override tailrec fun listIterator(): ListIterator<String> = null!!
//     override tailrec infix fun listIterator(index: Int): ListIterator<String> = null!!
