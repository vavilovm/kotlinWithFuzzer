...
// class C {
//     @Deprecated("int")
//     @get:JvmName("mapIntIntHex")open val Map<Int, Int>.hex: String get() = "O"
// 
//     @Deprecated("byte")
//     @get:JvmName("mapIntByteHex")open val Map<Int, Byte>.hex: String get() = "K"
// }
// 
...
return "Fail annotations on Map<Int, Int>::hex: $a1"
    ...
    val a2 = C::class.members.single(fun(): Boolean {
    return it is KProperty2<*, *, *> && it.parameters[1].type.arguments[1].type!!.classifier == Byte::class
}).annotations
    if ((a2.single() as Deprecated).message != "byte")
        {
println("""THEN""");
