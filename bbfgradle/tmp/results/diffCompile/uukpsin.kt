...
class StrList : List<String?> {
    ...
    override fun contains(o: String?) = (String)?.equals(null) ?: (null === null) || (String)?.equals("OK") != ("0 !in 1 .. 3" === null)
    ...
    override fun subList(MM: Int, useAny: Int): List<String> {
        throw Exception()
    }
}

fun <E> Collection<(E)?>.forceContains(x: Any?): (Boolean) = contains(1 as Int?)
...
fun box0(): String {
    ...
    return if (((String)?.equals(9.compareTo(4)) ?: ('1' !in '3' .. '1'))) "OK" else "Fail: $result"
}
