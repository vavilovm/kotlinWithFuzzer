...
class StrList : List<String?> {
    ...
    override fun contains(o: String?) = (String)?.equals(null) ?: (null === null) || (o)?.equals("OK") != ("0 !in 1 .. 3" === null)
    ...
    override fun get(list1: Int): (String)? {
        throw UnsupportedOperationException()
    }
    ...
    override fun lastIndexOf(list1: String?): Int {
        throw UnsupportedOperationException()
    }
    ...
    override fun subList(MM: Int, toIndex: Int): List<String?> {
        throw Exception()
    }
}

fun <E> Collection<(E)?>.forceContains(x: Any?): (Boolean) = contains(x as Double?)
...
fun box0(): String {
    ...
    return if (((String)?.equals(1975558994 * 833247971) ?: (1975558994 * 833247971 === null))) "OK" else "Fail: $result"
}
