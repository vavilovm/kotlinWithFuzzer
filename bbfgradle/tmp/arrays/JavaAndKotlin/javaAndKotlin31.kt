...
class BoxFunKt {
   ...
   public static final String box() {
      ForInUnsignedUntilKt.testSimpleUIntLoop();
      ForInUnsignedUntilKt.testEmptyUIntLoop();
      ForInUnsignedUntilKt.testSimpleULongLoop();
      ForInUnsignedUntilKt.testEmptyULongLoop();
      ForInUnsignedUntilKt.testULongLoop();
      ForInUnsignedUntilKt.testEmptyULongLoop2();
      ForInUnsignedUntilKt.testMaxUItoMinUI();
      ForInUnsignedUntilKt.testMaxULtoMinUL();
      ForInUnsignedUntilKt.testWrappingUIntLoop();
      ForInUnsignedUntilKt.testWrappingULongLoop();
      return "OK";
   }
}

// FILE: forInUnsignedUntil.kt
