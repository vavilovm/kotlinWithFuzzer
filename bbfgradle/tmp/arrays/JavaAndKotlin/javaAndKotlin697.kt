...
class BoxFunKt {
   ...
   public static final String box() {
      ...
      for(byte var1 = 22; fnI <= var1; ++fnI) {
         int testI = 0;

         for(byte var3 = 22; testI <= var3; ++testI) {
            if (fnI == testI) {
               ReifiedAsFunKBigKt.getTests()[testI].testGood(ReifiedAsFunKBigKt.getFns()[fnI]);
            } else {
               ReifiedAsFunKBigKt.getTests()[testI].testBad(ReifiedAsFunKBigKt.getFns()[fnI]);
            }
         }
      }
