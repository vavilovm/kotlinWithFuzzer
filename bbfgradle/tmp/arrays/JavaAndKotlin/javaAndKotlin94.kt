   ...
   public static final String box() {
      ...
      for(byte var1 = 22; fnI <= var1; ++fnI) {
         ...
         for(byte var3 = 22; testI <= var3; ++testI) {
            if (fnI == testI) {
               SafeAsFunKBigKt.getTests()[testI].testGood(SafeAsFunKBigKt.getFns()[fnI]);
            } else {
               SafeAsFunKBigKt.getTests()[testI].testBad(SafeAsFunKBigKt.getFns()[fnI]);
            }
         }
      }
