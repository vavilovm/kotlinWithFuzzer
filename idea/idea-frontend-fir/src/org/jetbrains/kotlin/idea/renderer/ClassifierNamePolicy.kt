...
interface ClassifierNamePolicy {
    object SHORT : ClassifierNamePolicy {
        override fun renderClassifier(classifier: ClassifierDescriptor, renderer: Renderer): String {
    ...
    fun renderClassifier(classifier: ClassifierDescriptor, renderer: Renderer): String
}