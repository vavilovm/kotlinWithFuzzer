...
class NodeCollector(val dir: String) {
    ...
    fun collect() {
        ...
        if (File("./bbfgradle/database.txt").exists()) File("./bbfgradle/database.txt").delete()
        val res = File("./bbfgradle/database.txt")
        database.forEach {
    ...
    fun collectJavaDB() {
        ...
        if (File("./bbfgradle/databaseJava.txt").exists()) File("./bbfgradle/databaseJava.txt").delete()
        val res = File("./bbfgradle/databaseJava.txt")
        database.forEach {
            res.appendText("${it.key} ${it.value}\n")
        }
    }
